...
from Test.SVM.app.preprocessing_hog_svm import pil_to_emnist_svm_vector
...
def main():
    ...
    x_vec = pil_to_emnist_svm_vector(pil_img, invert=False, do_transpose=TRAIN_TRANSPOSE)
